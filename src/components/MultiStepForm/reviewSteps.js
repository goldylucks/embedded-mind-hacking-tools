...
You are more than welcome to [share](FB_SHARE) this with others of course`,
  ...
  },
  {
    ...
    id: "payment",
    description:
      "This allows me to invest more time to improve these processes and help more people worldwide, just like you.",
    type: "payment",
    answers: [
...
Please don’t hold back. I take everything as constructive feedback.`,
  ...
  },
  {
    ...
    answers: [
      {
        text: "Get cutting edge tools",
        isLinkNew: true,
        linkNew: MESSENGER_LINK_INNER_CIRCLE,
      },
      ...
      {
        text: "Talk to me (Adam)",
        isLinkNew: true,
        linkNew: MESSENGER_LINK_WELCOME,
      },
      {
        text: "Book a session",
        isLinkNew: true,
        linkNew: MESSENGER_LINK_BOOK_SESSION,
      },
    ],
  },
];
